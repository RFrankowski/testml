...
public static class LoadFromEnumerable
{
    ...
    static void Main(string[] args)
    {
        ...
        {
               new DataPointVector{ Features = new float[]{ 1.2f, 3.4f, 4.5f, 3.2f,  7,5f   } ,CurrentPrice = 1 },
               new DataPointVector{ Features = new float[]{ 4.2f, 3.4f, 14.65f,  3.2f, 3,5f } ,CurrentPrice = 1  },
               new DataPointVector{ Features = new float[]{ 1.6f, 3.5f, 4.5f, 6.2f,  3,5f   } ,CurrentPrice = 1  },
        };
